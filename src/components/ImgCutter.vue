<template>
  <div>
    ...
    <button  type="button" v-if="!$slots.openImgCutter && !$slots.open" class="btn-btn btn-primary" @click="handleOpen">{{label}}</button>
          ...
          <transition
            ...
            <div class="dialogMain"
              ...
              <div class="toolMain">
                ...
                <div ref="toolBox"
                  ...
                  <div class="tips" v-show="!drawImg.img">
                    <div class="btn-btn btn-warning btn-xs" @click="chooseImg">选择图片</div>
                  </div>
                  <!--工具栏-->
              ...
              <span class="i-dialog-footer">
                    ...
                    <div class="btn-btn btn-primary btn-primary-plain" @click="chooseImg">选择图片</div>
                    <div class="btn-group fr">
                        <div class="btn-btn btn-default" @click="handleClose">取消</div>
                        <div class="btn-btn btn-primary" :disabled="!drawImg.img" type="primary"
